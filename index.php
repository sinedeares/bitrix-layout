...
<div class="container">
	...
	array(
		...
		"IBLOCK_ID" => "6",
		"SHOW_TO_UNAUTHORIZED_PERSONS" => "Y",
		"SEF_MODE" => "N",
		"PROPERTY_CODE" => array(
			0 => "28",
			1 => "",
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"category",1=>"title",2=>"about",3=>"link",4=>"formImage",5=>"",),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "Y",
		"SET_META_KEYWORDS" => "Y",
...
);?> <!-- Pagination --> <nav class="content-nav">
	<ul class="pager">
