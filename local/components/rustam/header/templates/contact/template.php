    ...
    <div class="container">
        <div class="row">
            <div class="<?= $arResult['classDiv'] ?? '' ?>">
                ...
                <?= $arResult['customBlock']['text'] ?> <<?= $arResult['customBlock']['sliceTag']?>>
                <<?= $arResult['customBlock']['aTag']?> href ="<?= $arResult['customBlock']['href']?>"> <?= $arResult['customBlock']['aText']?></<?= $arResult['customBlock']['aTag'] ?>>
                </<?= $arResult['customBlock']['tag'] ?>>
                 <? endif ?>
